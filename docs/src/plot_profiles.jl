...
tz_profiles = [
    (;
        func = APL.TRMM_LBA_radiation,
        kwargs = (; z_range = zr_hi, t_range, label = "radiation"),
    ),
    (;
        func = APL.ARM_SGP_dTdt,
        kwargs = (; z_range = zr_lo, t_range, label = "dTdt", units = "[K/s]"),
    ),
]
...
z_profiles = [
    ...
    (;
        func = APL.LifeCycleTan2018_θ_liq_ice,
        kwargs = (; z_range = zr_lo, xlabel = "θ_liq_ice"),
    ),
    ...
    (;
        func = APL.LifeCycleTan2018_tke_prescribed,
        kwargs = (; z_range = zr_lo, xlabel = "tke"),
    ),
    (;
        func = APL.LifeCycleTan2018_geostrophic_u,
        kwargs = (; z_range = zr_lo, xlabel = "u"),
    ),
    (;
        func = APL.LifeCycleTan2018_geostrophic_v,
        kwargs = (; z_range = zr_lo, xlabel = "v"),
    ),
    ...
    (;
        func = APL.LifeCycleTan2018_subsidence,
        kwargs = (; z_range = zr_lo, xlabel = "subsidence"),
    ),
    ...
    (;
        func = APL.Dycoms_RF01_θ_liq_ice,
        kwargs = (; z_range = zr_lo, xlabel = "θ_liq_ice"),
    ),
    ...
    (;
        func = APL.Dycoms_RF02_θ_liq_ice,
        kwargs = (; z_range = zr_lo, xlabel = "θ_liq_ice"),
    ),
    ...
    (;
        func = APL.DryBubble_updrafts_θ_liq_ice,
        kwargs = (; z_range = zr_lo, xlabel = "θ_liq_ice"),
    ),
    ...
    (;
        func = APL.ISDAC_subsidence,
        kwargs = (; z_range = zr_lo, xlabel = "subsidence", unit = "[m/s]"),
    ),
    (;
        func = APL.ISDAC_inv_τ_scalar,
        kwargs = (; z_range = zr_lo, xlabel = "inv_τ_scalar", unit = "[1/s]"),
    ),
    (;
        func = APL.ISDAC_inv_τ_wind,
        kwargs = (; z_range = zr_lo, xlabel = "inv_τ_wind", unit = "[1/s]"),
    ),
    ...
    (;
        func = APL.Larcform1_geostrophic_u,
        kwargs = (; z_range = zr_hi, xlabel = "u", unit = "[m/s]"),
    ),
    (;
        func = APL.Larcform1_geostrophic_v,
        kwargs = (; z_range = zr_hi, xlabel = "v", unit = "[m/s]"),
    ),
]
