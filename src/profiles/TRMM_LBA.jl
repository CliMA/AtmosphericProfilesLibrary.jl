...
function TRMM_LBA_p(::Type{FT}) where {FT}
    ...
    return FT ∘ Dierckx.Spline1D(z_in, p_in; k = 1)
end
""" [Grabowski2006](@cite) """
function TRMM_LBA_T(::Type{FT}) where {FT}
    ...
    return FT ∘ Dierckx.Spline1D(z_in, T_in; k = 1)
end
""" [Grabowski2006](@cite) """
function TRMM_LBA_RH(::Type{FT}) where {FT}
  z_in = TRMM_LBA_z(FT)
    ...
    return FT ∘ Dierckx.Spline1D(z_in, RH_in; k = 1)
end
""" [Grabowski2006](@cite) """
function TRMM_LBA_u(::Type{FT}) where {FT}
    ...
    return FT ∘ Dierckx.Spline1D(z_in, u_in; k = 1)
end
""" [Grabowski2006](@cite) """
function TRMM_LBA_v(::Type{FT}) where {FT}
    ...
    return FT ∘ Dierckx.Spline1D(z_in, v_in; k = 1)
end
...
function TRMM_LBA_radiation(::Type{FT}) where {FT}
    ...
    rad_in = hcat(rad_in...)'
    profile = FT ∘ Dierckx.Spline2D(rad_time, z_in, rad_in; kx = 1, ky = 1)
    return profile
end
